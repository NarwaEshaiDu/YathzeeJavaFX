package YathzeeGlobal.View.StartScreen;

import YathzeeGlobal.Model.*;
import YathzeeGlobal.View.*;
import YathzeeGlobal.View.MainScreen.MainScreenPresenter;
import YathzeeGlobal.View.MainScreen.MainScreenView;
import javafx.event.*;
...
public class StartScreenPresenter {
    ...
    public StartScreenPresenter(YathzeeModel model, StartScreenView view, UISettings uiSettings) {
        this.model = model;
        this.view = view;
