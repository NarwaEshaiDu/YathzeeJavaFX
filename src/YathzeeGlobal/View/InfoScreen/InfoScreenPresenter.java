package YathzeeGlobal.View.InfoScreen;

import YathzeeGlobal.Model.YathzeeModel;
...
public class InfoScreenPresenter {
    ...
    public InfoScreenPresenter(YathzeeModel model, InfoScreenView view, UISettings uiSettings) {
        this.model = model;
        this.view = view;
