package YathzeeGlobal.View.MainScreen;

import YathzeeGlobal.Model.*;
import YathzeeGlobal.View.AboutScreen.*;
import YathzeeGlobal.View.InfoScreen.*;
import YathzeeGlobal.View.SettingsScreen.*;
...
public class MainScreenPresenter {
    ...
    public MainScreenPresenter(YathzeeModel model, MainScreenView view, UISettings uiSettings) {
        this.model = model;
        this.view = view;
